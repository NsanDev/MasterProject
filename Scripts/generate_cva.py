...
from Scripts.cva_calculator import generate_cva_hull, generate_cva_indep
...
generate_cva_hull(V_alltimes, bs_hull, Q_default, name_saved_file='cva_hull', max_iter=10000000, tol=1e-3)
t = clock() - t
